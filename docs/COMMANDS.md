...
| `Ctrl+D` | Quit when idle. With `quit_armed`, the first idle press of `Ctrl+C`/`Ctrl+D` arms a pending quit and any other key cancels it; a second consecutive press of either key exits. |
